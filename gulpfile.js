...
//Svg
//const replace = require("gulp-replace"); // Change '&gt;', '>' in SVG
//const cheerio = require("gulp-cheerio"); // Remove Styles in SVG
//const svgSprite = require("gulp-svg-sprite"); //Merge all SVGs into one file
